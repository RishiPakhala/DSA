...
public class DirectedUnweightedgreph {
    static class Edge{
        int s,d;
        Edge(int s,int d){
            this.s=s;
    ...
    public static void main(String args[]) {
        DirectedUnweightedgreph ob = new DirectedUnweightedgreph(5); 
        ob.addEdge(0, 1);
        ob.addEdge(1, 2);
        ob.addEdge(2, 3);
    //    ob.addEdge(2, 3);
        ob.addEdge(3, 4); // Introducing a cycle
